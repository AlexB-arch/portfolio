...
h <- hist(temps$Temp, breaks=9, main="Everglades Temp. in Celcius", xlab="Temperature", ylab="Frequency", col="blue", border="black", xlim=c(25.5, 35.5), ylim=c(0, 20), labels=T)