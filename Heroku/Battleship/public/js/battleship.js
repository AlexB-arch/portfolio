    ...
    selector.moveSelectorLeft = function () {
        if (selector.type == 'ShipPlacer') {
            if (selector.position == 0) {
                ...
                for (var i = 0; i < you.board.uBoat.length; i++) {
                    if (
                        you.board.uBoat[i][1] == '1' &&
                        (you.board.uBoat[i].length == 2 || you.board.uBoat[i][2] != '0')
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.destroyer1.length; i++) {
                    if (
                        you.board.destroyer1[i][1] == '1' &&
                        (you.board.destroyer1[i].length == 2 || you.board.destroyer1[i][2] != '0')
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.destroyer2.length; i++) {
                    if (
                        you.board.destroyer2[i][1] == '1' &&
                        (you.board.destroyer2[i].length == 2 || you.board.destroyer2[i][2] != '0')
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.battleship.length; i++) {
                    if (
                        you.board.battleship[i][1] == '1' &&
                        (you.board.battleship[i].length == 2 || you.board.battleship[i][2] != '0')
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.aircraftCarrier.length; i++) {
                    if (
                        you.board.aircraftCarrier[i][1] == '1' &&
                        (you.board.aircraftCarrier[i].length == 2 ||
                            you.board.aircraftCarrier[i][2] != '0')
                    ) {
                        canMove = false;
                        break;
                    }
        ...
        if (selector.type == 'ShipPlacer') {
            if (selector.position == 0) {
                ...
                for (var i = 0; i < you.board.uBoat.length; i++) {
                    if (
                        you.board.uBoat[i][1] == '1' &&
                        you.board.uBoat[i].length >= 3 &&
                        you.board.uBoat[i][2] == '0'
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.destroyer1.length; i++) {
                    if (
                        you.board.destroyer1[i][1] == '1' &&
                        you.board.destroyer1[i].length >= 3 &&
                        you.board.destroyer1[i][2] == '0'
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.destroyer2.length; i++) {
                    if (
                        you.board.destroyer2[i][1] == '1' &&
                        you.board.destroyer2[i].length >= 3 &&
                        you.board.destroyer2[i][2] == '0'
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.battleship.length; i++) {
                    if (
                        you.board.battleship[i][1] == '1' &&
                        you.board.battleship[i].length >= 3 &&
                        you.board.battleship[i][2] == '0'
                    ) {
                        canMove = false;
                        break;
                    }
                ...
                for (var i = 0; i < you.board.aircraftCarrier.length; i++) {
                    if (
                        you.board.aircraftCarrier[i][1] == '1' &&
                        you.board.aircraftCarrier[i].length >= 3 &&
                        you.board.aircraftCarrier[i][2] == '0'
                    ) {
                        canMove = false;
                        break;
            ...
            if (selector.position == 0) {
                ...
                if (you.board.uBoat[0][0] == you.board.uBoat[1][0]) {
                    if (you.board.uBoat[1][0] <= 'I') {
                        ...
                        if (
                            you.board.uBoat[1].length >= 3 &&
                            you.board.uBoat[1].substring(1, 3) == '10'
                        ) {
                            newValue += '9' + you.board.uBoat[1].substring(3);
                        } else {
                            newValue +=
                                (Number(you.board.uBoat[1][1]) - 1).toString() +
                                you.board.uBoat[1].substring(2);
                        }
                ...
                // vertical to horizontal
                    ...
                    if (
                        you.board.uBoat[1].length == 2 ||
                        (you.board.uBoat[1].length >= 3 &&
                            you.board.uBoat[1].substring(1, 3) != '10')
                    ) {
                        let newValue =
                            rows[rows.indexOf(you.board.uBoat[1][0]) - 1].toString() +
                            (Number(you.board.uBoat[1][1]) + 1).toString();
                ...
                if (you.board.destroyer1[0][0] == you.board.destroyer1[1][0]) {
                    if (you.board.destroyer1[2][0] <= 'I') {
                        let newValue =
                            rows[rows.indexOf(you.board.destroyer1[1][0]) + 1].toString();
                        if (
                            you.board.destroyer1[1].length >= 3 &&
                            you.board.destroyer1[1].substring(1, 3) == '10'
                        ) {
                            newValue += '9' + you.board.destroyer1[1].substring(3);
                        } else {
                            newValue +=
                                (Number(you.board.destroyer1[1][1]) - 1).toString() +
                                you.board.destroyer1[1].substring(2);
                        }
                ...
                // vertical to horizontal
                    ...
                    if (
                        you.board.destroyer1[1].length == 2 ||
                        (you.board.destroyer1[1].length >= 3 &&
                            you.board.destroyer1[1].substring(1, 3) != '10')
                    ) {
                        let newValue =
            ...
            if (selector.type == 'ShipPlacer') {
                if (selector.position == 0) {
                    ...
                    if (you.board.destroyer1[0].length >= 3) {
                        selector.x =
                            297 + (Number(you.board.destroyer1[0].substring(1, 3)) - 1) * 49;
                    } else {
                    ...
                    if (you.board.destroyer2[0].length >= 3) {
                        selector.x =
                            297 + (Number(you.board.destroyer2[0].substring(1, 3)) - 1) * 49;
                    } else {
                    ...
                    if (you.board.battleship[0].length >= 3) {
                        selector.x =
                            297 + (Number(you.board.battleship[0].substring(1, 3)) - 1) * 49;
                    } else {
                    ...
                    if (you.board.aircraftCarrier[0].length >= 3) {
                        selector.x =
                            297 + (Number(you.board.aircraftCarrier[0].substring(1, 3)) - 1) * 49;
                    } else {
...
function playerReady(number) {
    ...
    socket.emit('chat', `Player ${player} ready`);
}
...
let playerNumber = 0;
let ready = false;
let oppnentReady = false;
let allShipsPlaced = false;
let attack = -1;

//Receives player number from server.
//0 = you.
//1 = opponent.
...
socket.on('player-connection', (number) => {
    ...
    playerConnectedOrDisconnected(number);
});
...
socket.on('attack', (id) => {
    ...
    socket.emit('attack-reply', square.classList);
    playGame(socket);
});

// On Fire Reply Received
socket.on('attack-reply', (classList) => {
